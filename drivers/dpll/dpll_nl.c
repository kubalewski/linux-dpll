...
static const struct nla_policy dpll_device_get_do_nl_policy[DPLL_A_BUS_NAME + 1] = {
...
static const struct nla_policy dpll_device_get_dump_nl_policy[DPLL_A_BUS_NAME + 1] = {
	[DPLL_A_ID] = { .type = NLA_U32, },
	[DPLL_A_BUS_NAME] = { .type = NLA_NUL_STRING, },
	[DPLL_A_DEV_NAME] = { .type = NLA_NUL_STRING, },
};
...
static const struct nla_policy dpll_device_set_nl_policy[DPLL_A_MODE + 1] = {
	...
	[DPLL_A_BUS_NAME] = { .type = NLA_NUL_STRING, },
	[DPLL_A_DEV_NAME] = { .type = NLA_NUL_STRING, },
	[DPLL_A_MODE] = NLA_POLICY_MAX(NLA_S32, 5),
};
...
static const struct nla_policy dpll_pin_set_nl_policy[DPLL_A_PIN_PARENT_IDX + 1] = {
	...
	[DPLL_A_PIN_STATE] = NLA_POLICY_MAX(NLA_U32, 2),
};
...
static const struct genl_split_ops dpll_nl_ops[6] = {
	{
		...
		.policy		= dpll_device_get_do_nl_policy,
